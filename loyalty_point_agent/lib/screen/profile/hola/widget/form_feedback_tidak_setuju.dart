...
class _FormFeedBackTidaSetujuState extends State<FormFeedBackTidaSetuju> {
  List<Map<String, dynamic>> data = [
    {
      'id': 'Informasi kurang informatif',
      'value': false,
    },
    {
      'id': 'Artikel tidak membantu',
      'value': false,
    },
    {
      'id': 'Artikel sulit ditemukan',
      'value': false,
    },
    {
      'id': 'Tampilan kurang menarik',
      'value': false,
    },
  ];
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      bool? pilihan3;
                      bool? pilihan4;
                      pilihan1 = data[0]['value'] == true ? false : null;
                      pilihan2 = data[1]['value'] == true ? false : null;
                      pilihan3 = data[2]['value'] == true ? false : null;
                      pilihan4 = data[3]['value'] == true ? false : null;
